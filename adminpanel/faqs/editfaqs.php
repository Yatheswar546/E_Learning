<?php
	...
	if( $_SERVER['REQUEST_METHOD'] == 'GET'){
		...
		$id = $_GET["id"];
        // read the data
        $result = mysqli_query($db,"SELECT * FROM `faqs` WHERE id=$id");
        ...
        do{          
			if(empty($id) || empty($que) || empty($ans)){
                $errormsg = "All Fields are required !!!";
                break;
            }
            else{
                // Edit new Faq into table
                $result = mysqli_query($db,"UPDATE `faqs` SET `que`='$que',`ans`='$ans' WHERE id = $id");
                ...
                if(!$result){
                    ...
                    $successmsg = "FAQ Updated Succesfully!!!";
			...
			<div class="container">
				...
				<div class="login form">
				  <form action="#" method="post">
                    	...
                    	<input type="text" name="que" placeholder="Enter queston" style="height: 100px;">
                    	
						<span class="span"> Enter description</span>
                    	<input type="text" name="ans" placeholder="Enter discription" style="height: 200px;">
